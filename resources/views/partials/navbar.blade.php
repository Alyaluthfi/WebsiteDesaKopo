<nav>
    ...
    <ul class="nav-links">
        ...
        <li><a href="{{ Route::is('home') ? '#kontak' : route('home') . '#kontak' }}">Kontak</a></li>
        @auth
            @if(Auth::user()->isAdmin())
                <li><a href="{{ route('admin.finance.index') }}" class="admin-badge"><i class="fa-solid fa-gauge"></i> Admin</a></li>
            @else
                <li><a href="{{ route('akun') }}" class="nav-user-name" style="text-decoration: none;"><i class="fa-solid fa-circle-user"></i> {{ explode(' ', Auth::user()->name)[0] }}</a></li>
            @endif
            <li>
        ...
        @else
            <li><a href="{{ route('admin.login') }}" class="login-btn"><i class="fa-solid fa-right-to-bracket"></i> Masuk</a></li>
        @endauth
    </ul>
</nav>
